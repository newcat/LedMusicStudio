...
export type Capability =
  ...
  | {
      dmxRange?: DmxRange;
      type: "BeamAngle";
      angle?: string | ("closed" | "narrow" | "wide");
      angleStart?: string | ("closed" | "narrow" | "wide");
      angleEnd?: string | ("closed" | "narrow" | "wide");
      comment?: string;
      helpWanted?: string;
      menuClick?: "start" | "center" | "end" | "hidden";
      switchChannels?: SwitchChannels;
...
export interface Physical {
  ...
  power?: number;
  powerConnectors?: {
    "IEC C13"?: "input only" | "output only" | "input and output";
    "IEC C19"?: "input only";
    powerCON?: "input only" | "output only" | "input and output";
    "powerCON TRUE1"?: "input only" | "output only" | "input and output";
    "powerCON TRUE1 TOP"?: "input only" | "output only" | "input and output";
    "powerCON 32 A"?: "input only";
    Hardwired?: "input only" | "output only" | "input and output";
    Proprietary?: "input only" | "output only" | "input and output";
  };
  DMXconnector?:
    | "3-pin"
    | "3-pin (swapped +/-)"
