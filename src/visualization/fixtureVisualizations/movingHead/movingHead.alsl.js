...
class MovingHead {
    ...
    set position(positionVector) {
        ...
        this._dummy.position.set(positionVector.x, positionVector.y, Math.max(positionVector.z, 0.51));
        this._matrixNeedsUpdate = true;
    }
    ...
    set rotation(rotationVector) {
        ...
        this._dummy.rotation.set(rotationVector.x, rotationVector.y, rotationVector.z);
        this._matrixNeedsUpdate = true;
    }
    ...
    set colorTemp(colorTemp = DEFAULT_COLOR_TEMP) {
        ...
        if (temp <= 66) {
            ...
            rgbData = [329.698727446 * (temp - 60) ** -0.1332047592, 288.1221695283 * (temp - 60) ** -0.0755148492, 255];
        }
    ...
    static prepareModelInstance() {
        ...
        yoke.geometry.translate(0, 0, -0.4);
    ...
    static prepareBeamInstance() {
        ...
        beamMesh = new THREE.InstancedMesh(
            beamGeo,
